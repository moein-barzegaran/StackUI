...
public class VStack: UIView {
    ...
    // MARK: Initializers
    public init(alignment: UIStackView.Alignment = .fill, distribution: UIStackView.Distribution = .fill, spacing: CGFloat = Constants.defaultSpacing, @ViewBuilder content: () -> [UIView]) {
